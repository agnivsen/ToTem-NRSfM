...
% (Filename modified by Agniva Sengupta [10-FEB-2023])
%
% According to [2], this code is loosely based on [1].


% [1]: Bernardini, F., Mittleman, J., Rushmeier, H., Silva, C., & Taubin, G. (1999). The ball-pivoting algorithm for surface reconstruction. 
%           IEEE transactions on visualization and computer graphics, 5(4), 349-359.
%
% [2]: Viswanathan, N. (2013). Calibration and 3D Model Generation for a Low-Cost Structured Light Foot Scanner (Master's thesis, 
