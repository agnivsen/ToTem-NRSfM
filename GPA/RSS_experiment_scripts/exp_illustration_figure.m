...
hFig = figure("Name", "Point-Clouds", "Position", [0, 0, 400, 440]);
tfig = tiledlayout(8, 7, "TileSpacing","tight");
...
ax1.LineWidth = 0.5;
hold on;
scatter(local_points1(1, vis1),local_points1(2, vis1), markersize*0.5, 'Marker', marker1, "MarkerEdgeColor", color1, "MarkerFaceColor", 'none');
hold off;
axis equal square;
box on;
...
ax2.LineWidth = 0.5;
hold on;
scatter(local_points2(1, vis2), local_points2(2, vis2), markersize*0.5, 'Marker', marker2, "MarkerEdgeColor", color2, "MarkerFaceColor", 'none');
hold off;
...
ax3.LineWidth = 0.5;
hold on;
scatter(local_points3(1, vis3), local_points3(2, vis3), markersize*0.5, 'Marker', marker3, "MarkerEdgeColor", color3, "MarkerFaceColor", 'none');
hold off;
axis equal square; box on;
...
ax4.LineWidth = 0.5;
hold on;
scatter(local_points4(1, vis4), local_points4(2, vis4), markersize*0.5, 'Marker', marker4, "MarkerEdgeColor", color4, "MarkerFaceColor", 'none');
hold off;
axis equal square; box on;
...
ax5.LineWidth = 0.5;
hold on;
hr1 = scatter(transform_points1(1, vis1), transform_points1(2, vis1), markersize, 'Marker', marker1, "MarkerEdgeColor", color1, "MarkerFaceColor", 'none');
hr2 = scatter(transform_points2(1, vis2), transform_points2(2, vis2), markersize, 'Marker', marker2, "MarkerEdgeColor", color2, "MarkerFaceColor", 'none');
hr3 = scatter(transform_points3(1, vis3), transform_points3(2, vis3), markersize, 'Marker', marker3, "MarkerEdgeColor", color3, "MarkerFaceColor", 'none');
hr4 = scatter(transform_points4(1, vis4), transform_points4(2, vis4), markersize, 'Marker', marker4, "MarkerEdgeColor", color4, "MarkerFaceColor", 'none');
